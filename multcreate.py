...
for x in range(1,11):
	listOfMuls.append('Kerekemes'+str(x))
...
songLines = [
	...
	'Бойтесь любви женщины больше, чем ненависти мужчины. (Сократ)', 
	'Нет боли, как долгая жизнь. (Софокл)', 
	'Никто не счастлив на протяжении всей своей жизни. (Еврипид)',
	'Хуже совершать несправедливость, чем терпеть ее, потому что тот, кто совершает ее, становится несправедливым, а кто нет. (Сократ)',
	'Человеческая наука заключается больше в том, чтобы уничтожать ошибки, чем в открытии истин. (Сократ)',
	'Лучший соус - это голод. (Сократ)',
	'Хорошие и красивые мужчины покоряют друг друга добротой. (Сократ)',
	'Мудрецы многому учатся у своих врагов. Афины Аристофан',
	'Мы должны искать в нашем зле другую причину, которая не является Богом. Платон',
	'Лучший хранитель вещи - также лучший вор. Платон',
	'Добродетель заключается в том, чтобы делать выгоды, которые, безусловно, не подходят. Сенека',
	'К пороку других, видя его мудрым. Сенека',
	'Когда вы находитесь в бедственном положении, уже слишком поздно, чтобы быть осторожным. Сенека',
	'Каждый стремится к блаженной жизни, но никто не знает, что это такое. Сенека',
	'Счастье тела основано на здоровье. Это понимание в знании. Фалес Милетский',
	'Лучше умереть сразу, чем всегда бояться за жизнь. Эзоп',
	'Счастье состоит в том, чтобы знать, как соединить конец с началом. Пифагор',
	'Красота - это великолепие истины. (Платон)',
	'Интеллект состоит не только в знаниях, но и в способности применять знания на практике. (Аристотель)',
	'То, что приобретается с большим трудом, больше любим. (Аристотель)',
	'Если ты обманул меня один раз, это твоя вина; Если ты изменяешь мне, это мое. (Анаксагор)',
	'Думайте так, как думают мудрые, но говорите так, как говорят простые люди. (Аристотель)',
	'Истинное счастье состоит в том, чтобы делать добро. (Аристотель)',
	'Одинокий человек - это зверь или бог. (Аристотель)',
	'При контакте любви каждый становится поэтом. (Платон)',
	'Научившись умирать, вы учитесь жить лучше. (Платон)',
	'Когда глаза обучаются астрономии, уши учатся воспринимать движения гармонии. (Платон)',
	'Страх - это страдание, которое порождает ожидание зла. (Аристотель)',
	'Если вы меня так хвалите, это будет потому, что вы хвалите себя, потому что, когда вы хвалите меня, они дают мне понять, что вы меня понимаете. (Аристотель)',
	'Я считаю более смелым того, кто побеждает свои желания, чем того, кто побеждает своих врагов, поскольку самая трудная победа - это победа над собой. (Аристотель)',
	'Помните, что секрет счастья заключается в свободе, а я в секрете свободы, мужества. (Фукидид)',
	'Человек, который не доволен ничем, не довольствуется ничем. (Эпикур Самосский)',
	'Счастье есть только там, где есть добродетель и серьезные усилия, потому что жизнь - это не игра. (Аристотель)',
	'Виртуоз доволен мечтать о том, что грешник делает в жизни. (Платон)',
	'Несчастье подвергает друзей испытаниям и обнаруживает врагов. (Эпитет)',
	'Есть только одно добро: знание. Есть только одно зло: невежество. (Сократ)',
	'Самая сладкая жизнь состоит в том, чтобы ничего не знать. (Софокл)',
	'Длительно только то, что достигается добродетелью. (Софокл)'
	]
